...
async function runMigration() {
    console.log('Starting tax_calculations table migration...');
    ...
    try {
        ...
        if (tableError) {
            console.error('Error creating tax_calculations table:', tableError);
            throw tableError;
        }

        console.log('✅ tax_calculations table created successfully');
