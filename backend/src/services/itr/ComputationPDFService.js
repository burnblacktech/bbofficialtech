  ...
  static async generatePDF(pdfData) {
    try {
      return new Promise((resolve, reject) => {
        ...
        doc.fontSize(7).fillColor(gray).text('Generated by BurnBlack · burnblack.in · This is a computation summary, not an official ITD document.', 50, footerY, { width: W, align: 'center' });
