...
async function resetPassword() {
    ...
    try {
        ...
        if (res.rows.length > 0) {
           ...
           VALUES ($1, $2, 'END_USER', 'Verified User', '9999999999', 'active', true, false, NOW(), NOW(), 'LOCAL', true, 0, $3)
        `, [email, passwordHash, uuidv4()]);
            console.log('User created with password User@123');
        }
    } catch (err) {
