      ...
      <div style={S.container}>
        ...
        <Card style={{ padding: 28 }}>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <Button variant="primary" type="submit" disabled={loading} style={S.submitBtn}>
              {loading ? 'Signing in...' : 'Sign In'}
            </Button>

            <div style={S.divider}><span style={S.dividerText}>Or</span></div>

            <Button variant="secondary" onClick={() => authService.googleLoginRedirect()} style={S.submitBtn}>
