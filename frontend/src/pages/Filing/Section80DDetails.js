    ...
    return (
        <div className="min-h-screen bg-slate-50 py-12 px-6">
            <div className="max-w-4xl mx-auto">
                ...
                {/* Summary and Actions */}
                <div className="text-sm text-slate-500 p-6 bg-blue-50 rounded-2xl border border-blue-100 flex items-start gap-3">
                    <Info className="w-5 h-5 text-blue-500 flex-shrink-0 mt-0.5" />
                    <div>
                        <p className="font-bold text-blue-900 mb-2">Deduction Limits</p>
                        <ul className="space-y-1 text-blue-700">
                            <li>• Self/Family (Non-Senior): ₹25,000 max</li>
                            <li>• Self/Family (Senior Citizen): ₹50,000 max</li>
                            <li>• Parents (Non-Senior): ₹25,000 max</li>
                            <li>• Parents (Senior Citizen): ₹50,000 max</li>
                            <li>• Preventive Checkup: ₹5,000 max (shared across all)</li>
                        </ul>
                    </div>
                </div>
