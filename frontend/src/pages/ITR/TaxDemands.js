      ...
      <div className="min-h-screen bg-neutral-50 py-8">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center py-12">
            ...
            <p className="text-slate-600">Loading tax demands...</p>
          </div>
        </div>
      </div>
    );
    ...
    <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
          <div className="bg-white rounded-xl shadow-elevation-1 border border-slate-200 p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-body-regular text-slate-600">Total Demands</p>
          ...
          <div className="bg-white rounded-xl shadow-elevation-1 border border-error-200 p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-body-regular text-slate-600">Outstanding</p>
          ...
          <div className="bg-white rounded-xl shadow-elevation-1 border border-success-200 p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-body-regular text-slate-600">Paid</p>
                <p className="text-heading-2 font-bold text-slate-900">
        ...
        <div className="bg-white rounded-xl shadow-elevation-1 border border-slate-200 p-4 mb-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div>
              <label className="block text-body-regular font-medium text-slate-700 mb-1">Demand Type</label>
              <select
