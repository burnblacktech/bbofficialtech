...
const IncomeSourcesSelection = () => {
    ...
    return (
        <div className="min-h-screen bg-slate-50 px-4 py-4 flex flex-col items-center">
            <div className="max-w-7xl w-full">
                ...
                <div className="text-center mb-4">
                    ...
                    <p className="text-sm text-slate-600">
                        Choose all that apply • AY {ay || filingData?.assessmentYear}
                    </p>
                </div>

                {/* Compact Income Sources Grid */}
                                ...
                                {category.sources.map((source) => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`flex items-center p-2.5 bg-white rounded-lg border-2 transition-all text-left group ${isSelected
                                                    ? source.activeColor
                                                    : `${source.color} hover:border-primary-200`
                                                }`}
                                        >
                                            <div className={`p-1.5 rounded-md mr-2 ${source.color} group-hover:scale-105 transition-transform flex-shrink-0`}>
                                            ...
                                            <div className="flex-1 min-w-0">
                                                <div className="flex items-center gap-1 mb-0.5">
                                                    ...
                                                    {source.prefilled && (
                                                        <Sparkles className="w-2.5 h-2.5 text-primary-600 flex-shrink-0" />
                                                    )}
                                                </div>
                                            ...
                                            {isSelected && (
                                                <CheckCircle className="w-4 h-4 text-primary-600 flex-shrink-0 ml-1" />
                                            )}
                                        </button>
                                    );
                                })}
                ...
                <div className="flex items-center justify-between gap-4 pt-2 border-t border-slate-200">
                    ...
                    <button
                        ...
                        className="flex items-center gap-2 px-6 py-2.5 bg-primary-600 text-white text-sm rounded-lg font-medium hover:bg-primary-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                    >
