                  ...
                  >
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        ...
                        <Typography.Small className="text-neutral-600 mb-3 block">
                          {ticket.description}
                        </Typography.Small>
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                          <Typography.Small className="text-neutral-500 block">Ticket ID</Typography.Small>
                          <Typography.Small className="font-medium block">{selectedTicket.id}</Typography.Small>
                        </div>
                        <div>
                          <Typography.Small className="text-neutral-500 block">Created</Typography.Small>
                          <Typography.Small className="font-medium block">{formatDate(selectedTicket.createdAt)}</Typography.Small>
                        </div>
                        <div>
                          <Typography.Small className="text-neutral-500 block">User</Typography.Small>
                          <Typography.Small className="font-medium block">{selectedTicket.user.name} ({selectedTicket.user.email})</Typography.Small>
                        </div>
                        <div>
                          <Typography.Small className="text-neutral-500 block">Assigned To</Typography.Small>
                      ...
                      <div className="space-y-4 max-h-64 overflow-y-auto">
                        {selectedTicket.messages.map((message, index) => (
                          ...
                          >
                            ...
                            >
                              <Typography.Small className="block">{message.message}</Typography.Small>
                              <Typography.Small className={`text-xs mt-1 block ${message.sender === 'user' ? 'text-neutral-500' : 'text-primary-100'
                                }`}>
