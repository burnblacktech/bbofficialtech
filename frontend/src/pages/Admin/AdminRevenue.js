...
export default function AdminRevenue() {
  ...
  if (isLoading) return <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 12, padding: 20 }}>{[1,2,3,4].map(i => <div key={i} style={{ height: 80, borderRadius: 12, background: 'var(--bb-bg-elevated, #f3f4f6)', animation: 'skeleton-pulse 1.5s ease-in-out infinite' }} />)}</div>;
