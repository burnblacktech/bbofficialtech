      ...
      <header className="bg-white border-b border-neutral-200 sticky top-0 z-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-heading-2 font-bold text-neutral-900">Document Management</h1>
            ...
            <div className="flex items-center space-x-3">
              <button
                ...
                className="flex items-center space-x-2 px-4 py-2 border border-neutral-300 rounded-xl text-body-regular font-medium text-neutral-700 hover:bg-neutral-50 transition-colors"
              >
                <Filter className="h-4 w-4" />
                <span>Filters</span>
              </button>
              <button className="flex items-center space-x-2 px-4 py-2 bg-primary-500 text-white rounded-xl text-body-regular font-medium hover:bg-primary-600 transition-colors">
          ...
          <div className="bg-white rounded-xl border border-neutral-200 p-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <p className="text-body-regular font-medium text-neutral-700">Storage Usage</p>
            ...
            <div className="mt-4 pt-4 border-t border-neutral-200 grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                ...
                <select
                  ...
                  className="w-full px-3 py-2 border border-neutral-300 rounded-xl text-body-regular focus:outline-none focus:ring-2 focus:ring-primary-500"
                >
          ...
          <>
                ...
                <table className="min-w-full divide-y divide-neutral-200">
                  <thead className="bg-neutral-50">
                    <tr>
                      ...
                      <th className="px-6 py-3 text-right text-body-small font-medium text-neutral-500 uppercase tracking-wider">
                        Actions
                      </th>
                    </tr>
                  </thead>
                  <tbody className="bg-white divide-y divide-neutral-200">
                    {documents.map((doc) => (
                      <tr key={doc.id} className="hover:bg-neutral-50">
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="flex items-center">
                            ...
                            <div>
                              ...
                              <div className="text-body-small text-neutral-500">ID: {doc.id}</div>
                            </div>
                          </div>
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="text-body-regular text-neutral-900">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <span className="px-2 py-1 text-body-small font-medium bg-primary-100 text-primary-800 rounded-full">
            ...
            {pagination && pagination.totalPages > 1 && (
              <div className="mt-6 flex items-center justify-between">
                <div className="text-body-regular text-neutral-500">
                ...
                <div className="flex items-center space-x-2">
                  <button
                    ...
                    className="px-3 py-2 border border-neutral-300 rounded-xl text-body-regular font-medium text-neutral-700 hover:bg-neutral-50 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    Previous
                  </button>
                  <span className="px-3 py-2 text-body-regular text-neutral-700">
