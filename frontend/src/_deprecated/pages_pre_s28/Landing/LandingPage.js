...
const TrustIndicators = memo(({ stats, isLoading }) => {
  ...
  return (
    <div className="mt-12 grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
      <div className="bg-white p-6 rounded-xl border-2 border-gold-200 shadow-elevation-2 hover:shadow-elevation-3 transition-shadow text-center">
      ...
      <div className="bg-white p-6 rounded-xl border-2 border-gold-200 shadow-elevation-2 hover:shadow-elevation-3 transition-shadow text-center">
        ...
        <div className="text-body-sm text-slate-600 mt-1">Support</div>
      </div>
    </div>
  );
});
