  ...
  return (
    <div className="space-y-6">
      ...
      <div className="border border-slate-200 rounded-xl p-4">
        <h4 className="font-semibold text-slate-900 mb-4">Salary Income</h4>
        <div>
          <label className="block text-body-regular font-medium text-slate-700 mb-1">Salary Income (₹)</label>
          <input
            type="number"
            value={data.salary || 0}
      ...
      <div className="border border-slate-200 rounded-xl p-4">
        <div className="flex items-center justify-between mb-4">
          <h4 className="font-semibold text-slate-900">Presumptive Business Income (Section 44AD)</h4>
          <div className="flex items-center gap-2">
            ...
            />
            <label className="text-body-regular text-slate-700">I have presumptive business income</label>
          </div>
        </div>
          ...
          <div className="space-y-4 mt-4">
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                className="w-4 h-4 text-blue-600 border-slate-300 rounded focus:ring-gold-500"
              />
              <label className="text-body-regular text-slate-700">Opt out of presumptive scheme (declare actual profit)</label>
            </div>
            ...
            {!presumptiveBusiness.optedOut ? (
              <>
                ...
                <div className="bg-slate-50 border border-slate-200 rounded-xl p-4">
                  <div className="flex justify-between items-center">
                    <span className="font-semibold text-slate-900">Presumptive Income (Auto-calculated):</span>
              ...
              <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-3">
                <p className="text-body-regular text-yellow-800">
      ...
      <div className="border border-slate-200 rounded-xl p-4">
        <div className="flex items-center justify-between mb-4">
          <h4 className="font-semibold text-slate-900">Presumptive Professional Income (Section 44ADA)</h4>
          <div className="flex items-center gap-2">
            <input
              type="checkbox"
              ...
              className="w-4 h-4 text-blue-600 border-slate-300 rounded focus:ring-gold-500"
            />
            <label className="text-body-regular text-slate-700">I have presumptive professional income</label>
          </div>
        </div>
          ...
          <div className="space-y-4 mt-4">
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                className="w-4 h-4 text-blue-600 border-slate-300 rounded focus:ring-gold-500"
              />
              <label className="text-body-regular text-slate-700">Opt out of presumptive scheme (declare actual income)</label>
            </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 border border-slate-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-gold-500"
                    />
                    <p className="text-body-small text-slate-500 mt-1">Maximum ₹50 lakhs for ITR-4</p>
                  </div>
                  ...
                  <div>
                    ...
                    />
                    <p className="text-body-small text-slate-500 mt-1">Fixed at 50% for professionals</p>
                  </div>
                </div>
      ...
      <div className="border border-slate-200 rounded-xl p-4">
        <h4 className="font-semibold text-slate-900 mb-4">Other Income</h4>
        <div>
          <label className="block text-body-regular font-medium text-slate-700 mb-1">Other Income (₹)</label>
          <input
            type="number"
            ...
            className="w-full px-3 py-2 border border-slate-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-gold-500"
          />
          <p className="text-body-small text-slate-500 mt-1">Interest, dividends, winnings, etc.</p>
        </div>
      </div>
    </div>
  );
