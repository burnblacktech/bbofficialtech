        ...
        <div className="mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
            ...
            >
              ...
              <div className="text-body-small text-slate-600 mt-1">Business (Turnover ≤ ₹2 Cr)</div>
            </button>
            <button
            ...
            >
              ...
              <div className="text-body-small text-slate-600 mt-1">Profession (Receipts ≤ ₹50 L)</div>
            </button>
            <button
            ...
            >
              ...
              <div className="text-body-small text-slate-600 mt-1">Goods Carriage</div>
            </button>
          </div>
        </div>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  max={20000000}
                />
                <p className="text-body-small text-slate-500 mt-1">Maximum ₹2 crores for Section 44AD</p>
              </div>
              ...
              <div>
                ...
                <label className="flex items-center gap-2">
                  ...
                  />
                  <span className="text-body-regular text-slate-700">All receipts are digital (8% or 6% rate)</span>
                </label>
              </div>
              ...
              <div>
                ...
                {!formData.digitalReceipts && (
                  <p className="text-body-small text-slate-500 mt-1">Non-digital receipts: 5% rate (auto-applied)</p>
                )}
              </div>
            </div>
            ...
            <div className="bg-green-50 border border-green-200 rounded-xl p-4">
              <div className="flex items-center justify-between">
                <span className="font-semibold text-slate-900">Presumptive Income (Section 44AD):</span>
                <span className="text-heading-3 font-bold text-green-700">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="md:col-span-2">
                ...
                <input
                  ...
                  value={50}
                />
                <p className="text-body-small text-slate-500 mt-1">Fixed at 50% for Section 44ADA</p>
              </div>
            </div>

            <div className="bg-green-50 border border-green-200 rounded-xl p-4">
              <div className="flex items-center justify-between">
                <span className="font-semibold text-slate-900">Presumptive Income (Section 44ADA):</span>
                <span className="text-heading-3 font-bold text-green-700">
                  ₹{formData.presumptiveIncome?.toLocaleString('en-IN') || '0'}
                </span>
              </div>
          ...
          <div className="space-y-4">
            <div className="bg-green-50 border border-green-200 rounded-xl p-4">
              <div className="flex items-start gap-2">
                ...
                <div className="text-body-regular text-green-800">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  min={0}
                />
                <p className="text-body-small text-slate-500 mt-1">₹7,500/month per vehicle</p>
              </div>
            ...
            <div className="bg-green-50 border border-green-200 rounded-xl p-4">
              <div className="flex items-center justify-between">
                <span className="font-semibold text-slate-900">Presumptive Income (Section 44AE):</span>
                <span className="text-heading-3 font-bold text-green-700">
                  ₹{formData.presumptiveIncome?.toLocaleString('en-IN') || '0'}
                </span>
              </div>
