...
const BusinessIncomeForm = ({ filingId, data, onUpdate, selectedITR, onDataUploaded }) => {
  // Business income (detailed) is only applicable for ITR-3
  if (selectedITR !== 'ITR-3' && selectedITR !== 'ITR3') {
    return null;
  }

  const isITR4 = false; // Business income detailed form is not for ITR-4
      ...
      <div className="space-y-4">
        <div>
          ...
          <input
            ...
            max={20000000}
          />
          <p className="text-body-small text-slate-500 mt-1">Maximum ₹2 crores for ITR-4</p>
        </div>
        ...
        <div className="bg-slate-50 rounded-xl p-4">
          <div className="flex items-center justify-between">
            <span className="font-semibold text-slate-900">Presumptive Income:</span>
    ...
    return (
      <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="border border-slate-200 rounded-xl p-4 bg-blue-50">
              <div className="flex items-start space-x-3">
                ...
                <div className="flex-1">
                  <h4 className="font-semibold text-slate-900 mb-1">AIS Business Income</h4>
            ...
            <div className="border border-slate-200 rounded-xl p-4 bg-blue-50">
              <div className="flex items-start space-x-3">
                ...
                <div className="flex-1">
                  <h4 className="font-semibold text-slate-900 mb-1">GST Data Import</h4>
                  <p className="text-body-regular text-slate-600 mb-3">
                    Import business data from GST returns (coming soon)
                  </p>
                  <button
                    disabled
                    className="inline-flex items-center px-4 py-2 border border-slate-300 rounded-xl bg-slate-100 text-slate-400 cursor-not-allowed"
                  >
        ...
        {businesses.map((business, businessIndex) => (
          <div key={businessIndex} className="border border-slate-200 rounded-xl p-6 bg-white">
            {/* Business Header */}
            ...
            <div className="mb-6">
              ...
              >
                <span className="font-medium text-slate-700">Business Details</span>
              ...
              {expandedSections[`businessDetails-${businessIndex}`] && (
                <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-body-regular font-medium text-slate-700 mb-1">Business Name</label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label className="block text-body-regular font-medium text-slate-700 mb-1">Nature of Business</label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label className="block text-body-regular font-medium text-slate-700 mb-1">Business PAN (if applicable)</label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label className="block text-body-regular font-medium text-slate-700 mb-1">GST Number (if applicable)</label>
                    <input
                      type="text"
                  ...
                  <div className="md:col-span-2">
                    <label className="block text-body-regular font-medium text-slate-700 mb-1">Business Address</label>
                    <textarea
            ...
            {/* P&L Statement */}
            <div className="space-y-4">
              <h5 className="font-semibold text-slate-900 border-b pb-2">Profit & Loss Statement</h5>

              {/* Basic P&L Fields */}
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <div className="flex items-center gap-2 mb-1">
                    <label className="block text-body-regular font-medium text-slate-700">Gross Receipts/Turnover (₹)</label>
                ...
                <div>
                  <label className="block text-body-regular font-medium text-slate-700 mb-1">Opening Stock (₹)</label>
                  <input
                    type="number"
                ...
                <div>
                  <label className="block text-body-regular font-medium text-slate-700 mb-1">Purchases (₹)</label>
                  <input
                    type="number"
                ...
                <div>
                  <label className="block text-body-regular font-medium text-slate-700 mb-1">Closing Stock (₹)</label>
                  <input
                    type="number"
              ...
              <div>
                <button
                  ...
                  className="flex items-center justify-between w-full p-3 bg-slate-50 rounded-xl hover:bg-slate-100 transition-colors"
                >
                  <span className="font-medium text-slate-700">Direct Expenses</span>
                  <div className="flex items-center gap-2">
                ...
                {expandedSections[`directExpenses-${businessIndex}`] && (
                  <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      <label className="block text-body-regular font-medium text-slate-700 mb-1">Raw Materials (₹)</label>
                      <input
                        type="number"
                    ...
                    <div>
                      <label className="block text-body-regular font-medium text-slate-700 mb-1">Wages & Salaries (₹)</label>
                      <input
                        type="number"
                    ...
                    <div>
                      <label className="block text-body-regular font-medium text-slate-700 mb-1">Power & Fuel (₹)</label>
                      <input
                        type="number"
                    ...
                    <div>
                      <label className="block text-body-regular font-medium text-slate-700 mb-1">Freight & Carriage (₹)</label>
                      <input
                        type="number"
                    ...
                    <div className="md:col-span-2">
                      <label className="block text-body-regular font-medium text-slate-700 mb-1">Other Direct Expenses (₹)</label>
                      <input
                        type="number"
              ...
              <div>
                <button
                  ...
                  className="flex items-center justify-between w-full p-3 bg-slate-50 rounded-xl hover:bg-slate-100 transition-colors"
                >
                  <span className="font-medium text-slate-700">Indirect Expenses</span>
                  <div className="flex items-center gap-2">
                    <span className="text-body-regular text-slate-600">
                ...
                {expandedSections[`indirectExpenses-${businessIndex}`] && (
                  <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      <label className="block text-body-regular font-medium text-slate-700 mb-1">Rent (₹)</label>
                      <input
                        type="number"
                    ...
                    <div>
                      <label className="block text-body-regular font-medium text-slate-700 mb-1">Salaries (₹)</label>
                      <input
                        type="number"
                    ...
                    <div>
                      <label className="block text-body-regular font-medium text-slate-700 mb-1">Utilities (₹)</label>
                      <input
                        type="number"
                    ...
                    <div>
                      <label className="block text-body-regular font-medium text-slate-700 mb-1">Insurance (₹)</label>
                      <input
                        type="number"
                    ...
                    <div>
                      <label className="block text-body-regular font-medium text-slate-700 mb-1">Advertising (₹)</label>
                      <input
                        type="number"
                    ...
                    <div>
                      <label className="block text-body-regular font-medium text-slate-700 mb-1">Professional Fees (₹)</label>
                      <input
                        type="number"
                    ...
                    <div className="md:col-span-2">
                      <label className="block text-body-regular font-medium text-slate-700 mb-1">Other Indirect Expenses (₹)</label>
                      <input
                        type="number"
              ...
              <div>
                <button
                  ...
                  className="flex items-center justify-between w-full p-3 bg-slate-50 rounded-xl hover:bg-slate-100 transition-colors"
                >
                  <span className="font-medium text-slate-700">Depreciation</span>
                  <div className="flex items-center gap-2">
                    <span className="text-body-regular text-slate-600">
                ...
                {expandedSections[`depreciation-${businessIndex}`] && (
                  <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      <label className="block text-body-regular font-medium text-slate-700 mb-1">Building (₹)</label>
                      <input
                        type="number"
                    ...
                    <div>
                      <label className="block text-body-regular font-medium text-slate-700 mb-1">Machinery (₹)</label>
                      <input
                        type="number"
                    ...
                    <div>
                      <label className="block text-body-regular font-medium text-slate-700 mb-1">Furniture & Fixtures (₹)</label>
                      <input
                        type="number"
              ...
              {/* Other Expenses */}
              <div>
                <label className="block text-body-regular font-medium text-slate-700 mb-1">Other Expenses (₹)</label>
                <input
                  type="number"
        ...
        {businesses.length > 0 && (
          <div className="bg-blue-50 rounded-xl p-4 border border-blue-200">
            <div className="flex items-center justify-between">
              <span className="font-semibold text-slate-900">Total Net Business Income:</span>
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          <label className="block text-body-regular font-medium text-slate-700 mb-1">Gross Receipts/Turnover (₹)</label>
          <input
            type="number"
            value={data?.grossReceipts || 0}
            onChange={(e) => handleChange('grossReceipts', parseFloat(e.target.value) || 0)}
        ...
        <div>
          <label className="block text-body-regular font-medium text-slate-700 mb-1">Direct Expenses (₹)</label>
          <input
            type="number"
        ...
        <div>
          <label className="block text-body-regular font-medium text-slate-700 mb-1">Indirect Expenses (₹)</label>
          <input
            type="number"
        ...
        <div>
          <label className="block text-body-regular font-medium text-slate-700 mb-1">Depreciation (₹)</label>
          <input
            type="number"
      ...
      <div className="bg-slate-50 rounded-xl p-4">
        <div className="flex items-center justify-between">
          <span className="font-semibold text-slate-900">Net Profit from Business:</span>
          <span className="text-body-large font-bold text-slate-900">
            ₹{(
