...
const AuditInformationForm = ({ filingId, selectedITR, onUpdate }) => {
  ...
  if (isError) {
    return <div className="text-center py-8 text-error-600">Error loading audit information</div>;
  }
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    {errors.auditReportNumber && (
                      <p className="text-body-small text-error-600 mt-1">{errors.auditReportNumber.message}</p>
                    )}
                  </div>
                  <div>
                    <label className="block text-body-regular font-medium text-slate-700 mb-1">
                    ...
                    {errors.auditReportDate && (
                      <p className="text-body-small text-error-600 mt-1">{errors.auditReportDate.message}</p>
                    )}
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    {errors.caDetails?.caName && (
                      <p className="text-body-small text-error-600 mt-1">{errors.caDetails.caName.message}</p>
                    )}
                  </div>
                  <div>
                    <label className="block text-body-regular font-medium text-slate-700 mb-1">
                    ...
                    {errors.caDetails?.membershipNumber && (
                      <p className="text-body-small text-error-600 mt-1">{errors.caDetails.membershipNumber.message}</p>
                    )}
                  </div>
