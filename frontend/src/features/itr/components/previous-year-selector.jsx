...
const PreviousYearSelector = ({ userId: propUserId, memberId: propMemberId = null, currentAssessmentYear: propAssessmentYear = '2024-25', onSelect }) => {
  ...
  const getStatusBadge = (status) => {
    ...
    const config = statusConfig[status] || { color: 'bg-slate-100 text-gray-800', label: status };
      ...
      <div className="min-h-screen bg-slate-50 py-8">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-center py-12">
            ...
            <span className="text-body-md text-slate-600">Loading previous year filings...</span>
          </div>
        </div>
      </div>
    );
      ...
      <div className="min-h-screen bg-slate-50 py-8">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-8">
            ...
            <h1 className="text-heading-2xl text-slate-900 mb-2">Copy from Previous Year</h1>
          ...
          <div className="bg-white rounded-xl border border-slate-200 p-12 text-center">
            ...
            <h3 className="text-heading-md text-slate-900 mb-2">No Previous Filings Found</h3>
            ...
            <div className="flex gap-4 justify-center">
              <button
                onClick={() => navigate(-1)}
                className="px-4 py-2 border border-slate-300 rounded-xl text-body-regular font-medium text-slate-700 bg-white hover:bg-slate-50"
              >
                Go Back
              </button>
              <button
                onClick={() => navigate('/itr/computation', { state: { dataSource: 'manual' } })}
                className="px-4 py-2 bg-gold-500 text-white rounded-xl text-body-regular font-medium hover:bg-gold-600"
              >
                Start Fresh
              </button>
            </div>
  ...
  return (
    <div className="min-h-screen bg-slate-50 py-8">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <button
                ...
                className={`w-full text-left p-6 rounded-xl border-2 transition-all ${
                  isSelected
                    ...
                    : 'border-slate-200 bg-white hover:border-slate-300 hover:shadow-elevation-1'
                }`}
              >
                <div className="flex items-start space-x-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-3">
                      <div className="flex items-center text-body-sm text-slate-600">
        ...
        {/* Info Box */}
        {selectedFilingId && (
          <div className="mb-8 bg-info-50 border border-info-200 rounded-xl p-4">
            <div className="flex">
