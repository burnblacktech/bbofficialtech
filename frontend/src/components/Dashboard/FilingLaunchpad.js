      ...
      <div className="relative p-5">
        ...
        <div className="relative">
          <div className="flex items-center gap-4 mb-4">
            {/* Icon */}
            <div className="flex items-center justify-center w-14 h-14 bg-aurora-gradient rounded-2xl shadow-lg shadow-primary-500/20 flex-shrink-0">
          ...
          <div className="flex items-center gap-2 mb-4 flex-wrap">
            <div className="flex items-center px-3 py-1.5 bg-white rounded-lg shadow-sm border border-primary-100">
              <Zap className="w-3.5 h-3.5 text-primary-500 mr-2" />
              <span className="text-xs font-medium text-slate-700">AI-Powered</span>
            </div>
            <div className="flex items-center px-3 py-1.5 bg-white rounded-lg shadow-sm border border-success-100">
              <Shield className="w-3.5 h-3.5 text-success-500 mr-2" />
              <span className="text-xs font-medium text-slate-700">Bank-Grade Security</span>
            </div>
            <div className="flex items-center px-3 py-1.5 bg-white rounded-lg shadow-sm border border-ember-100">
              <Sparkles className="w-3.5 h-3.5 text-ember-500 mr-2" />
              <span className="text-xs font-medium text-slate-700">Maximize Refunds</span>
            </div>
          </div>
          ...
          <button
            ...
            className="w-full flex items-center justify-center px-5 py-3 bg-aurora-gradient text-white text-sm font-semibold rounded-xl hover:opacity-90 transform hover:scale-[1.01] active:scale-[0.99] transition-all duration-200 shadow-lg shadow-primary-500/30"
          >
