...
const ITRSelectionCards = ({ onSelect, selectedITR = null }) => {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-3 h-full">
      {ITR_CARDS.map((itr) => {
        ...
        return (
          <motion.div
            ...
            className={cn(
              'rounded-lg border-2 overflow-hidden transition-all flex flex-col min-w-0',
              isSelected
          ...
          >
            <div className="bg-white p-3 flex flex-col h-full">
              ...
              <button
                ...
                className={cn(
                  'w-full py-1.5 px-2 rounded-lg text-xs font-semibold transition-all flex items-center justify-center gap-1.5 flex-shrink-0',
                  isSelected
      ...
      <div className="col-span-1 md:col-span-2 bg-blue-50 border border-blue-200 rounded-lg p-2 flex items-start gap-1.5 flex-shrink-0">
